$.fn.scrollsteps = function (options) {
    ...
    var defauts = {
        transitionDuration: 1500, // Duration of the main transition event,
        ...
        quietPeriodBetweenTwoScrollEvents: 500, // Increases responsiveness, minimum delay between two quiet periods (no scroll events) to force the transition event if the transitionDuration is not completed.
    };
